...
//        // (Assuming the parameter is the root of a BST)
    ...
    //THE LONG WAY
//    public LinkedListNode<Song> getSongList2(){ //returns Linked List node of Songs
//        this.SortedSong = getSongListHelper2(this.songBST);
//        return SortedSong;
//
//    }


    //retreiving the sorted list, using in order.
//    public LinkedListNode<Song> getSongListHelper2(BinaryTreeNode<Song> node) {
//        //node = this.songBST;
//        //return this.SortedSong;
//        //the returned node would be the head of the Linked list according to the Comparator
//        //So, songTitle comparator will return head based on title
...
//        if (node != null) {
//            if (SortedSong == null){
//                SortedSong = new LinkedListNode<>(node.getValue(), null);
//            }
//
//            //String out = "";
//            //LinkedListNode<Song> SortedSongs = SortedS;
//            if (node.getLeft() != null){
//                System.out.println("left: " + node.getLeft().getValue().getTitle());
//            }
//            if(node.getRight() != null){
//                System.out.println("right: " + node.getRight().getValue().getTitle());
//            }
//
//            SortedSong.append(getSongListHelper2(node.getLeft()).getValue());
//            //rooter.append(node.getValue());
//            SortedSong.append(getSongListHelper2(node.getRight()).getValue());
//            SortedSong.append(node.getValue());
//            return SortedSong;
//        } else {
//            return SortedSong;
//        }
